...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/casadocode$1.0.0/src/app/views/livros/lista/lista.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<html><head><meta charset=\"UTF-8\"><title>Node é TOP</title></head><body>");
  ...
  out.w("</table><script src=\"/static/js/remove.js\"></script>");
...
marko_template.meta = {
    id: "/casadocode$1.0.0/src/app/views/livros/lista/lista.marko",
    tags: [
