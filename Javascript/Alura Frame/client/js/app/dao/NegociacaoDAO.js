            ...
            _export('NegociacaoDAO', NegociacaoDAO = function () {
                ...
                _createClass(NegociacaoDAO, [{
                    ...
                    value: function listaTodos() {
                        ...
                        return new Promise(function (resolve, reject) {
                            var cursor = _this2._connection.transaction([_this2._store], 'readwrite').objectStore('negociacoes').openCursor();
                            var negociacoes = [];
                    ...
                    key: 'apagarDados',
                    value: function apagarDados() {
                        var _this3 = this;

                        return new Promise(function (resolve, reject) {
                            var request = _this3._connection.transaction([_this3._store], 'readwrite').objectStore('negociacoes').clear();
